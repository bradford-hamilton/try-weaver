...
func init() {
	codegen.Register(codegen.Registration{
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "try-weaver/Reverser", Method: "Reverse"})}
		},
